            ...
            <div id="panel-container">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6">
                        <div class="card blue-grey darken-1">
                            <div class="card-content white-text center-align waves-effect waves-light">
                                <a href="admin?ver=cursos"><span class="card-title">Cursos</span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col s12 m6">
                        <div class="card blue-grey darken-1">
                            <div class="card-content white-text center-align waves-effect waves-teal">
                                <a href="admin?ver=noticias"><span class="card-title">Noticias</span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col s12 m6">
                        <div class="card blue-grey darken-1">
                            <div class="card-content white-text center-align waves-effect waves-teal">
                                <a href="admin?ver=profesores"><span class="card-title">Profesores</span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col s12 m6">
                        <div class="card blue-grey darken-1">
                            <div class="card-content white-text center-align waves-effect waves-teal">
                                <a href="admin?ver=alumnos"><span class="card-title">Alumnos</span></a>
                            </div>
                        </div>
                    </div>
